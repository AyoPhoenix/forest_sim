...
public class Forest2 {
	...
	public Forest2(int r, int c, int heatSpreadDist, double heatLostPerUpdate, double heatDissipation) {
		this(r, c);
	...
	public double getAveragePercentBurned(int height, int width, double density, int trials) {
		...
		for(int t = 0; t < trials; t++) {
			Forest2 forest = new Forest2(height, width);
